 ...
 <!-- Closing Div Tag for Assessment Information SECTION -->
    ...
    <div id="structure" class="tvt-section-group pagebreakhere">
     ...
     <!-- Closing Div Tag for Foundation 1 -->
        ...
        <!-- If walls are generic for all sections -->
     ...
     <!-- Closing Div Tag for Walls (Front) -->
           ...
           <!-- Closing Div Tag for Walls (Back) -->
          ...
          <!-- Closing Div Tag for Walls (Right) -->
         ...
         <!-- Closing Div Tag for Walls (Left) -->
